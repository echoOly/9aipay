...
<script type="text/javascript"> URL= window.UEDITOR_HOME_URL||"__PUBLIC__/ueditor/"; </script> 
          ...
          <tr>
            ...
            <td width="560">
                ...
                <tr>
                  ...
                  <input type="button"  value="上传图片" style="width:70px;cursor:pointer;" id="uploadid" onclick="upImage()"/>
                  <script type="text/javascript">
                    var myEditorImage;
                    var d; 
                    var myEditorImage= new UE.ui.Editor();
                     
      ...
      <td width="100%" id="arcBody" align="center">
       <textarea name="content" id="contentid"  style="width:950px;height:400px;" class="required" ></textarea>
        <script type="text/javascript">       
            ...
            editor.render("contentid");//1.2.4以后可以使用一下代码实例化编辑器//UE.getEditor('myEditor') 
        </script> 
	    </td>
