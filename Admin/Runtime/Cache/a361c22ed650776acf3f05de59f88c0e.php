  ...
  <tr>
    <td>
     <div style='float:left'>
     	欢迎使用个人博客系统【<?php echo (C("CFG_SUBTITLE")); ?>】
     </div>
            ...
            <dd class='intable'>
                <table width="98%" class="dboxtable">
                    <tr>
                        ...
                        <td class='nline' style="text-align:left"><a href="http://www.9aipay.com" target="_blank" style="color:blue"><?php echo (C("CFG_AUTHOR")); ?></a></td>
                    </tr>
                    <tr>
                        <td height='36' class='nline' style="text-align:center">在线帮助：</td>
                        <td class='nline' style="text-align:left">
                            <a href="http://www.9aipay.com" target="_blank" style="color:blue">个人主页</a>
                            &nbsp;&nbsp;
                            <a href="tencent://message/?uin=1042745891&Site=www.9aipay.com&Menu=yes" title="点我在线咨询" target="_blank">
                                <img src="__PUBLIC__/admin/images/qq.png"/>
                            </a>
                        </td>
                    </tr>
                </table>
