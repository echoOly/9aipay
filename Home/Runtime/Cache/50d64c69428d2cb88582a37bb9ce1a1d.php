...
<head>
    ...
    <!-- Title -->
	<title><?php echo ($article["title"]); ?> - <?php echo ($colname); echo (C("CFG_WEBNAME")); ?></title>
	...
	<div class="editorChoice box J_fixedBox_t">
		...
		<div class="left box">
			<div class="position">
				...
				&nbsp;
				<a href="<?php echo U('home/Index/index');?>">首页</a> \ 
				<a href="<?php echo ($article["colurl"]); ?>"><?php echo ($article["colname"]); ?></a> \ 
			...
			<div class="article-detail">
				<ul class="news">  
					<li>
	            		...
	            		<span>
	            			<em class="views"><?php echo ($article["click"]); ?>次点击</em> 
	            			<a href="javascript:void(0)" class="replies">
	            				<?php echo ($article["commentnum"]); ?>条评论
	            			</a>
	            			<a href="#" title="分享到新浪微博" class="share">分享</a>
	            		</span>
	            		<a href="<?php echo ($article["colurl"]); ?>" title="查看 <?php echo ($article["colname"]); ?> 中的全部文章"><?php echo ($article["colname"]); ?></a>  
	            		|  <?php echo ($article["createtime"]); ?>
	            		<p>
		            		<?php if($article["pic"] != ''): ?><img width="605" src="<?php echo ($article["pic"]); ?>" alt="<?php echo ($article["title"]); ?>" /><?php endif; ?>
						</p>
						<!-- <p><?php echo ($article["description"]); ?></p> -->
	        		</li>
				</ul>				
			</div>
			<div class="article-html"><?php echo ($article["content"]); ?></div>
			<div class="article-author">
				...
				<div class="aright">
					...
					<span>转载请注明来源:</span> 
					<a href="<?php echo U('home/Index/index');?>"> <?php echo (C("CFG_WEBNAME")); ?> </a>-<a href="<?php echo ($article["arcurl"]); ?>">《<?php echo ($article["title"]); ?>》</a><br/>
					<span>本文链接地址:</span> 
					<a href="<?php echo ($article["arcurl"]); ?>" title="<?php echo ($article["title"]); ?>"><?php echo (C("CFG_INDEXURL")); echo ($article["arcurl"]); ?></a>						
				</div>
    		</div>
    		<div class="art-rpybox">
				...
				<div class="art-form" style="margin-top:20px" id="comments">
					<form action="<?php echo U('Comment/saveComment');?>" method="post" name="myform">
						...
						<p class="im">
							...
							<img id="verifyImg" src="<?php echo U('Public/verify');?>" onClick="show(this);" alt="点击刷新验证码" title="点击刷新验证码" class="ci"/>
						</p>
			...
			<div class="page-navigation">
				<div class="nav-previous"><?php echo ($article["nextarc"]); ?> </div>
				<div class="nav-next"><?php echo ($article["prearc"]); ?></div>
			</div>
...
function show(obj){
	obj.src = "<?php echo U('home/Public/verify');?>";
}
$(document).ready(function(){
	var i = 0;
	loadContent("<?php echo U('Comment/getComment');?>",'<?php echo ($article["arcid"]); ?>',i);
